...
public class GetuiModule extends ReactContextBaseJavaModule {
    ...
    public void initPush() {
        GetuiLogger.log("initPush");
        if (mRAC != null) {
            PushManager.getInstance().initialize(mRAC.getApplicationContext(), PushService.class);
            PushManager.getInstance().registerPushIntentService(mRAC.getApplicationContext(), PushIntentService.class);
        }
